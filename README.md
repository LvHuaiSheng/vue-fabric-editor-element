# vue-fabric-editor-element
基于 fabric.js 和 Vue 开发的图片编辑器，可自定义字体、素材、设计模板。

## 新特性
1. 基于[vue-fabric-editor](https://nihaojob.github.io/vue-fabric-editor/)功能基础改为element-plus
2. 增加psd文件导入解析

### Git地址
Gitee:
```shell
 git clone https://gitee.com/sourcenet/vue-fabric-editor-element
```
Github
```shell
 git clone https://github.com/LvHuaiSheng/vue-fabric-editor-element
```
[vue-fabric-editor](https://gitee.com/sourcenet/vue-fabric-editor-element)
